...
// CopyFactUnits provides a mock function with given fields: ctx, len, next
func (_m *MockRepo) CopyFactUnits(ctx context.Context, len int, next func(int) (repo.FactUnit, error)) error {
	ret := _m.Called(ctx, len, next)
...
func (_e *MockRepo_Expecter) CopyFactUnits(ctx interface{}, len interface{}, next interface{}) *MockRepo_CopyFactUnits_Call {
	return &MockRepo_CopyFactUnits_Call{Call: _e.mock.On("CopyFactUnits", ctx, len, next)}
}

func (_c *MockRepo_CopyFactUnits_Call) Run(run func(ctx context.Context, len int, next func(int) (repo.FactUnit, error))) *MockRepo_CopyFactUnits_Call {
	_c.Call.Run(func(args mock.Arguments) {
